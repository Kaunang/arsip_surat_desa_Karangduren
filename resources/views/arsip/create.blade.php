...
@section('content')
  ...
  <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation mt-4"
    novalidate>
    @csrf
    ...
    <div class="row align-items-center mb-3">
      ...
      <div class="col-sm-3">
        <input type="text" id="nomor_surat" name="nomor_surat" class="form-control" value="{{ old('nomor_surat') }}"
          required>
    ...
    <div class="row align-items-center mb-3">
      ...
      <div class="col-sm-5">
        ...
        <div class="form-text">Hanya menerima file .pdf</div>
